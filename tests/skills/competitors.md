...
get_my_tenant -> list_sites -> get_business_context -> ranked_keywords (location_name, limit 200) -> competitor_domains (limit 10, location_code if known) -> serp_rank_check (one per named term, five at most)
